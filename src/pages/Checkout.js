...
const Checkout = () => {
    ...
    return (
        <div>
            ...
            <div className='flex flex-wrap lg:flex-nowrap lg:justify-center w-full mb-4'>
                <div className="p-5 shadow-md border-t-2 border-amber-400 mt-8 lg:ml-10 mx-2 w-full lg:w-1/2">
                    <div className='divide-y-2'>
                        <div className='w-full'>
                            <img className='rounded-md w-full object-cover' src={thumbnail} alt="" />
                        </div>
                ...
                <div className='w-full'>
                    <form onSubmit={proceedPayment} className='mt-8 rounded border shadow-lg lg:mx-5 border-t-2 border-amber-400 mx-2'>
                        <div className="grid sm:max-w-5xl grid-cols-6 gap-4 col-span-full lg:col-span-3 px-5 lg:px-5 py-5">
