...
const Footer = () => {
    return (
        <footer className="px-4 mt-10 relative divide-y dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-base gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-300">© 2022 TeleCourse Co. All rights reserved.</div>
        </footer>
    );
};
