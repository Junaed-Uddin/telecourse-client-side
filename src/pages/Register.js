...
const Register = () => {
    const { userEmailAndPassword, emailVerify, profileUpdate, githubLogin, googleSignIn } = useContext(AuthContext);
    ...
    return (
        <div className='flex justify-center items-center py-5'>
            <div className='flex flex-col max-w-md p-4 rounded-md sm:py-2 sm:px-8 bg-gray-100 text-gray-900 border border-t-4 border-amber-400'>
                <div className='mb-3 text-center'>
                    <h1 className='my-2 text-4xl font-bold text-amber-500 font-mono'>Register</h1>
                ...
                <p className='px-6 pb-3 text-sm text-center text-gray-400'>
                    Already have an account yet?{' '}
                    <Link to='/login' className='hover:underline text-amber-500 font-semibold'>
                        Sign In
                    </Link>
                </p>
            </div>
